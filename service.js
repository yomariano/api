module.exports = function() {
    ...
    return {
         ...
         */
        order: async function order(action, price, quantity,token, walletAdress, privateKey) {
            let res = await this.returnNextNonce(walletAdress);
       
            let contractAddress = await this.returnContractAddress(walletAdress);
